...
$work_experience = [
    [
        ...
        'descrip' => 'I used spreadsheets to sort and chart financial information
assisting PA with routine admin tasks',
    ],
    [
        'name' => 'Financial Analyst',
        'date' => 'Sep 2018 - Dec 2021',
        'descrip' => 'Created financial reports and supported all areas of responsibility within a 5 person finance team',
    ],
    [
        'name' => 'Sales Manager',
        'date' => 'Jan 2022 - Current',
        'descrip' => 'Recommended computerized bookkeeping and supervised all data entry, improved sales projections, advertising and budget planning',
    ],
];
?>
<!DOCTYPE html>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
           ...
           <h5 class="w3-opacity"><b><?php echo $work_experience[$i]['name'];?></b></h5>
            ...
            <p><?php echo $work_experience[$i]['descrip'];?></p>
            <hr>
          </div>
          <?php endfor; ?>
        </div>
